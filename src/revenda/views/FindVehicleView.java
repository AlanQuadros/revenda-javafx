...
import revenda.controllers.FindVehicleController;
import revenda.models.Vehicle;

public class FindVehicleView {
    @FXML
    ...
    private final FindVehicleController findVehicleController = new FindVehicleController();
    ...
    public void onFindClick() {
        ...
        try {
            Vehicle vehicle = findVehicleController.find(tfFind.getText());
